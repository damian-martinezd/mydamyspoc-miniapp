package com.walmartlabs.ern.mydamyspocminiapp;

import com.walmartlabs.ern.container.miniapps.MydamyspocMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MydamyspocMiniappActivity.class;
